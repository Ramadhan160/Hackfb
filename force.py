...
def banner():
    os.system('clear')
    print " "
    runntxt(GL+"                 ♥ SELAMAT DATANG PARA DUDA♥")
    time.sleep(1.5)
    print GG+"  ======================================="
    print GL+"  ••••••   BRUTE FORCE FACEBOOK.   ••••••"
    print GG+"  ======================================="
    print GL+"              JANGAN LUPA MAKAN"
    print Y+"♦ Created : PUTRA DUDA"
    print Y+"♦ Team : DUDA SEDUNIA"
    print Y+"♦ Github : https://github.com/Putra-DD"
    print Y+"♦ YouTube : HackTollabah"
    print GG+"  ======================================="
...
def main():
	global noobs
        ...
        life()
        print " "
        print RR+" wordlist tak ado yg cocok..."
        print " "
def BLANK(hack_password):
  try:
  	sys.stdout.write(GG+"\n[\033[91m+\033[92m]\033[91;1m [\033[97m"+email_target+"\033[91m]\033[90m Mencoba ==> \033[91m[\033[90;1m"+hack_password)
	sys.stdout.flush()
...
def runn_noobs():
         ...
         lop = GG+"""
             \033[90;1mPutraduda-hackteam\033[91;1m
             Creator by:\033[97m KONTOL
      """
